...
namespace API.Controllers
{
    ...
    public class LoginController : BaseController<LoginController>
    {
        ...
        [AllowAnonymous]
        [HttpPost]
        public ActionResult<BaseResponse<SignInResponse>> Facebook([FromBody] FacebookRequest request)
        {
            var response = new BaseResponse<SignInResponse>();
            response.Data = new SignInResponse();

            FacebookClient client = new FacebookClient("886642638791083", "10e69d51b45b7e39740056f9b66db9b3");
            var FBresponse = client.GetAsync("/me?fields=email,id,first_name,last_name", request.FacebookToken);

            string id = (string)FBresponse.Result.SelectToken("id");
            string firstName = (string)FBresponse.Result.SelectToken("first_name");
            string lastName = (string)FBresponse.Result.SelectToken("last_name");
            string email = (string)FBresponse.Result.SelectToken("email");
